...
export const any: { [key: number]: Icon } = {
  180: {
    sizes: '180x180',
    src: `${site.protocol + site.domain}/assets/penguin@180.png`,
    type: 'image/png',
  },
  192: {
    sizes: '192x192',
    src: `${site.protocol + site.domain}/assets/penguin@192.png`,
    type: 'image/png',
  },
  512: {
    sizes: '512x512',
    src: `${site.protocol + site.domain}/assets/penguin@512.png`,
    type: 'image/png',
  },
}
